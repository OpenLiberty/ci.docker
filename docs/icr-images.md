...
The `beta` tag is based on UBI Minimal and the latest Java JRE and provides the most recent beta release of Liberty, which includes all the features and capabilities from the most recent release, plus new and updated features that are currently in development.

Append a tag to `icr.io/appcafe/open-liberty` to pull a specific image. For example: 
```
icr.io/appcafe/open-liberty:26.0.0.9-kernel-slim-java25-openj9-ubi-minimal
```
...
The following tags include the most recent Open Liberty version: `26.0.0.9`
...
```
26.0.0.9-kernel-slim-java25-openj9-ubi-minimal
26.0.0.9-kernel-slim-java21-openj9-ubi-minimal
26.0.0.9-kernel-slim-java17-openj9-ubi-minimal
26.0.0.9-kernel-slim-java11-openj9-ubi-minimal
26.0.0.9-kernel-slim-java8-openj9-ubi-minimal
26.0.0.9-kernel-slim-java8-ibmjava-ubi-minimal

26.0.0.9-kernel-slim-java17-openj9-ubi
26.0.0.9-kernel-slim-java11-openj9-ubi
26.0.0.9-kernel-slim-java8-openj9-ubi
26.0.0.9-kernel-slim-java8-ibmjava-ubi
...
```
26.0.0.6-kernel-slim-java25-openj9-ubi-minimal
26.0.0.6-kernel-slim-java21-openj9-ubi-minimal
26.0.0.6-kernel-slim-java17-openj9-ubi-minimal
26.0.0.6-kernel-slim-java11-openj9-ubi-minimal
26.0.0.6-kernel-slim-java8-openj9-ubi-minimal
26.0.0.6-kernel-slim-java8-ibmjava-ubi-minimal

26.0.0.6-kernel-slim-java17-openj9-ubi
26.0.0.6-kernel-slim-java11-openj9-ubi
26.0.0.6-kernel-slim-java8-openj9-ubi
26.0.0.6-kernel-slim-java8-ibmjava-ubi

26.0.0.6-full-java25-openj9-ubi-minimal
26.0.0.6-full-java21-openj9-ubi-minimal
26.0.0.6-full-java17-openj9-ubi-minimal
26.0.0.6-full-java11-openj9-ubi-minimal
26.0.0.6-full-java8-openj9-ubi-minimal
26.0.0.6-full-java8-ibmjava-ubi-minimal

26.0.0.6-full-java17-openj9-ubi
26.0.0.6-full-java11-openj9-ubi
26.0.0.6-full-java8-openj9-ubi
26.0.0.6-full-java8-ibmjava-ubi
```

## 26.0.0.3

```
26.0.0.3-kernel-slim-java25-openj9-ubi-minimal
26.0.0.3-kernel-slim-java21-openj9-ubi-minimal
26.0.0.3-kernel-slim-java17-openj9-ubi-minimal
26.0.0.3-kernel-slim-java11-openj9-ubi-minimal
26.0.0.3-kernel-slim-java8-openj9-ubi-minimal
26.0.0.3-kernel-slim-java8-ibmjava-ubi-minimal

26.0.0.3-kernel-slim-java17-openj9-ubi
26.0.0.3-kernel-slim-java11-openj9-ubi
26.0.0.3-kernel-slim-java8-openj9-ubi
26.0.0.3-kernel-slim-java8-ibmjava-ubi
